...
def test_to_tabular_default_resource(specimen: dict, to_tabular: Callable):
...
def test_to_tabular_program_resource(specimen: dict, to_tabular: Callable):
...
def test_to_tabular_project_resource(specimen: dict, to_tabular: Callable):
...
def test_to_tabular_deep_field_list(specimen: dict, to_tabular: Callable, specimen_fields: list[str]):
